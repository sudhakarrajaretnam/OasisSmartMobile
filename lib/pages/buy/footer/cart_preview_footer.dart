...
import 'package:oasis_smart_services/pages/buy/delivery_address.dart';
...
class CartPreviewFooter extends ConsumerStatefulWidget {
  //final String fromPage;
  const CartPreviewFooter({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _CartPreviewFooter();
}

class _CartPreviewFooter extends ConsumerState<CartPreviewFooter> {
  @override
  void initState() {
    super.initState();
    ...
    return AnimatedSlide(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Text(
              "${cart.length} item${cart.length > 1 ? 's' : ''} | $currency${totalPrice.toStringAsFixed(0)}",
